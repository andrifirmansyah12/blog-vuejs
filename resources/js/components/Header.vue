<template>
    <header>
        <!-- Loader -->
        <div class="loader-body" v-if="!isloaded">
            <div class="loader-circle-3"></div>
        </div>

        <div class="nav container">
            <a href="" @click="homePage()" class="logo"
                >Andri <span>Firmansyah</span></a
            >
            <a href="" @click="loginPage()" class="login">Log In</a>
        </div>
    </header>
</template>
